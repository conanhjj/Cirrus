...
# From fusepy project https://github.com/terencehonles/fusepy
# In memory fuse file directory
# In order to run it, you must have FUSE and fusepy installed.
...
class Memory(LoggingMixIn, Operations):
    ...
    def write(self, path, data, offset, fh):
        ...
        'Below are test fec encoding and deconding'
        print "Write %s triggered. Writted %d" % (path,len(data))
        print "--------------------"
        print data
        'do fec encoding'
